...
{
    public interface IPayerNonEVVValidator
    {
        Task<List<ScheduleEVVInfoDto>> ValidatePayerNonEVVFlag(int HHA, int UserID, List<ScheduleEVVInfoDto> HHASchedulesList);
    }
}
